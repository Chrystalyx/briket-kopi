        ...
        <form action="{{ route('admin.products.store') }}" method="POST">
            ...
            <div class="space-y-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                        <label for="quantity" class="block text-sm font-medium">Stok</label>
                ...
                <div>
                    ...
                    <textarea name="description" id="description" rows="4" class="mt-1 block w-full px-4 py-2.5 border rounded-lg"></textarea>
                </div>
            </div>
            <div class="flex justify-end items-center mt-8 pt-4 border-t">
                ...
                <button type="submit" class="bg-blue-600 text-white font-medium py-2.5 px-5 rounded-lg">Simpan</button>
            </div>
        </form>
    </div>
</div>
